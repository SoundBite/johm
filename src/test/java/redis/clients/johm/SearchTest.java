...
public class SearchTest extends JOhmTestBase {
	...
	public void cannotSearchWithOnNotIndexedFields() {
		...
		JOhm.find(User.class, "room", "tworoom");
	}
	...
	public void canDoMultiFind() {
		...
		List<User> gotUsers=JOhm.find(User.class,false,new NVField("age",88), new NVField("name","b"));
		assertEquals(1,gotUsers.size());
		assertEquals(88,gotUsers.get(0).getAge());
		assertEquals("b",gotUsers.get(0).getName());

		gotUsers=JOhm.find(User.class,false,new NVField("age", 88), new NVField("country","name", "somewhere"));
		assertEquals(2,gotUsers.size());

		gotUsers=JOhm.find(User.class,false,new NVField("age", 88), new NVField("country","name", "somewhere"), new NVField("address","streetName", "xyz"));
		assertEquals(1,gotUsers.size());
		assertEquals(88,gotUsers.get(0).getAge());
		assertEquals(somewhere,gotUsers.get(0).getCountry());

		gotUsers = JOhm.find(User.class,false, new NVField("address","streetName", "xyz"));
		assertEquals(1,gotUsers.size());
	}
	...
	public void canDoMultiFindWithRangeConditions() {
		...
		List<User> gotUsers=JOhm.find(User.class,false,new NVField("age", 55, Condition.LESSTHANEQUALTO), new NVField("name","b"));
		assertEquals(1,gotUsers.size());

		gotUsers=JOhm.find(User.class,false, new NVField("age", 55, Condition.LESSTHANEQUALTO));
		assertEquals(3,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 2000, Condition.LESSTHANEQUALTO));
		assertEquals(3,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 2000, Condition.LESSTHANEQUALTO), new NVField("age", 55, Condition.LESSTHANEQUALTO));
		assertEquals(2,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 2000, Condition.GREATERTHANEQUALTO));
		assertEquals(4,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 2000, Condition.GREATERTHANEQUALTO), new NVField("age", 55, Condition.LESSTHANEQUALTO));
		assertEquals(2,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 2000, Condition.GREATERTHANEQUALTO), new NVField("age", 55, Condition.GREATERTHANEQUALTO));
		assertEquals(3,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 1000, Condition.LESSTHANEQUALTO), new NVField("age", 88, Condition.GREATERTHANEQUALTO), new NVField("name","f"));
		assertEquals(0,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 1000, Condition.LESSTHANEQUALTO), new NVField("age", 55, Condition.GREATERTHANEQUALTO), new NVField("name","f"));
		assertEquals(1,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 2000, Condition.LESSTHAN));
		assertEquals(1,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 2000, Condition.LESSTHAN), new NVField("age", 55, Condition.EQUALS));
		assertEquals(1,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 2000, Condition.LESSTHAN), new NVField("age", 55, Condition.EQUALS), new NVField("name","f"));
		assertEquals(1,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 2000, Condition.LESSTHAN), new NVField("age", 55, Condition.LESSTHAN), new NVField("name","f"));
		assertEquals(0,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 3000, Condition.LESSTHAN), new NVField("age", 55, Condition.LESSTHANEQUALTO), new NVField("name","b"));
		assertEquals(1,gotUsers.size());

		gotUsers = JOhm.find(User.class,false, new NVField("salary", 3000, Condition.GREATERTHAN));
		assertEquals(1,gotUsers.size());

		gotUsers=JOhm.find(User.class,false,new NVField("age", 88, Condition.LESSTHAN), new NVField("country","name", "somewhere"));
		assertEquals(1,gotUsers.size());

		gotUsers=JOhm.find(User.class,false,new NVField("age", 88, Condition.LESSTHANEQUALTO), new NVField("address","houseNumber", "12"));
		assertEquals(1,gotUsers.size());

		gotUsers=JOhm.find(User.class,false,new NVField("age", 88, Condition.LESSTHANEQUALTO), new NVField("address","houseNumber", 12, Condition.LESSTHANEQUALTO));
		assertEquals(1,gotUsers.size());
	...
	public void canDoMultiFindWithRangeConditionsWithTransactedSave() {
		...
		gotUsers=JOhm.find(User.class,false,new NVField("age", 88, Condition.GREATERTHANEQUALTO), new NVField("name", "b"));
		assertEquals(0,gotUsers.size());
	}
}
